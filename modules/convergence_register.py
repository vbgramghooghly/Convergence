        ...
        with st.expander("✏️ Edit or 🗑️ Delete an Activity", expanded=False):
            ...
            if selected_edit_id:
                ...
                with st.form("edit_conv_form"):
                    ...
                    new_v_fund = col_e2.number_input("VB-G RAM G Fund (₹ Lakhs)", value=float(rec.get('vbgramg_fund', 0.0)))
                    ...
                    if st.form_submit_button("Update Activity Details"):
                        ...
                        update_payload = {
                            ...
                            # REMOVED: "total_converged_fund" because it's generated by the database
                        }
                        try:
