...
def show():
    ...
    report_type = st.selectbox("Select Report", [
        "Official VB-G RAM G Summary Report (Template)", # Added as primary option
    ...
    if report_type == "Official VB-G RAM G Summary Report (Template)":
        ...
        st.caption("This format matches the official primary data export template. Missing fields are left blank for manual entry post-export.")
        ...
        official_df["Number / Status (e.g no of AWC in the district)"] = "" # Placeholder
        official_df["Scheme of the Deptt."] = "" # Placeholder
        official_df["Scope under Annual Plan [in respect of column (4)]"] = "" # Placeholder
        official_df["Desired Target for FY 2026-27 [in respect of column (6)]"] = df["desired_target"]
        ...
        official_df["Fund to be provided by VB-G RAM G (Rs. Cr)"] = df["vbgramg_fund"]
    ...
    # ========================================================
        ...
        scheme_perf['Financial%'] = (scheme_perf['Financial_Ach'] / scheme_perf['Target'].replace(0, 1)) * 100 
