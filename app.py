...
st.markdown(f"""
    <style>
        ...
        /* Targets the first horizontal block (our custom Navbar) */
        ...
        /* 4. CONTEXTUAL SECONDARY NAVIGATION (SLIM TABS) */
...
def render_profile_menu():
    """Renders the compact profile popover."""
...
def render_top_navigation():
    """Renders the professional single-line primary navigation bar."""
    if allowed_admin:
    ...
    # 3. Hidden Admin Menu (Only for Superadmin)
    if allowed_admin:
        with cols[2]:
